					...
					<form action="{{route('order.2')}}" method="post">
						...
						<div class="row align-items-center">
							<div class="col mt-4">
								...
								<input name="domain" type="text" class="form-control" placeholder="akudandia" style="padding-left: 180px;" value="{{!empty($order['domain'])?$order['domain']:null}}" onkeyup="nospaces(this)" required>
							</div>
						</div>
