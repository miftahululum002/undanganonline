        ...
        <div class="col-xl-12 col-lg-12 mb-4">
            <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <a class="m-0 float-right btn btn-danger btn-sm" href="#admin/pembayaran">Lihat Lebih <i class="fas fa-chevron-right"></i></a>
                </div>
                                    ...
                                    <td>
                                        <div class="btn-group mb-1">
                                            ...
                                            <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);">
                                                <a href="#" class="dropdown-item" data-nama="<?= $row->nama_lengkap ?>" data-bank="<?= $row->nama_bank ?>" data-invoice="<?= $row->invoice ?>" data-toggle="modal" data-target="#modalData">Lihat</a>
                                                <a href="#" class="dropdown-item konfirmasiBtn" data-id="<?= $row->id_user ?>" data-toggle="modal" data-target="#modalKonfirmasi">Konfirmasi & Aktifkan</a>
                                            </div>
                                    </td>
                                </tr>
                            <?php } ?>
...
<script>
    ...
    $('#modalData').on('show.bs.modal', function(e) {
        ...
        $('#nama_bank').val(bank);
        // $('#bukti').attr('src', '/assets/bukti/' + invoice + '.png');
    });
